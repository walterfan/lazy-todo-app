...
- frontend data and UI contract changes -> `05-data-and-api.md`, `09-testing.md`
- tray, window, or lifecycle changes -> `02-architecture.md`, `06-workflows.md`, `10-runbook.md`
- release, build, or workflow changes -> `08-build.md`
- documentation process changes -> `12-document.md`, `ai-guide.md`
...
- `00-overview.md` to `12-document.md` as the core project docs
...
Use this workflow when adding a new documentation page such as `12-document.md`.
...
- `12-document.po` when this page changes
...
- `10-runbook.md` for local setup, debugging, and verification commands
