...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::agents::get_agent_plugin_directory_settings,
            commands::agents::save_agent_plugin_directory_settings,
            ...
            commands::agents::uninstall_agent_plugin,
            commands::agents::install_agent_plugin_zip,
            commands::agents::get_agent_plugin_detail,
